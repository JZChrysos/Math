...
\begin{document}
	...
	$$
	To meet a condition-set means to obey at least one of its conditions. We can express $|\mathtt{G}|=\omega$ by
	$$
	|\mathtt{G}|=\omega  \iff (\forall n): \mathtt{G} \text{ meets } E_n.
	$$
